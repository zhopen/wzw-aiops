...
file = open(r'C:\zhanghan\wzw\aiops\data\dataSample\k8s_containers.20180417_00.core-cmhadoop7-9.log', 'r')
...
file.close()
str_1 = log_df[u'log'][0]
row_num = log_df.iloc[:,0].size
len_list = []
sd_list = []
for i in range(row_num):
    str_len = len(log_df[u'log'].values[i].encode('utf-8'))
    str_2 = log_df[u'log'][i]
    sd = Levenshtein.ratio(str_1,str_2) #文本相似性
...
results.to_csv(r'C:\zhanghan\wzw\aiops\results_2000_1.csv', sep=',', header=False, index=False)